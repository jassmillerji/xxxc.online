...
const SidebarProvider = React.forwardRef(
  (
    ...
    React.useEffect(() => {
      if (typeof document !== 'undefined') {
        document.body.dataset.sidebarOpen = openMobile;
      }
    }, [openMobile])
...
const Sidebar = React.forwardRef(
  (
      ...
      return (
        <>
          ...
          <div
            ...
            data-mobile="true"
            className={cn(
                "fixed top-16 left-0 w-full z-40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 text-sidebar-foreground flex flex-col transition-transform duration-300 ease-in-out md:hidden",
    ...
    return (
      <div
        ref={sidebarRef}
        className={cn("group text-sidebar-foreground hidden md:block")}
        data-state={state}
        data-collapsible={state === "collapsed" && collapsible !== "offcanvas" ? "icon" : ""}
        data-variant={variant}
        data-side={side}
      >
        <div
          className={cn(
            "duration-200 fixed top-0 bottom-0 z-40 hidden h-full w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            "bg-background/95 backdrop-blur",
            side === "left"
              ? "left-0"
              : "right-0",
             "group-data-[state=collapsed]:w-[--sidebar-width-icon]",
             collapsible === "offcanvas" && "group-data-[state=collapsed]:-left-[--sidebar-width]",
...
const SidebarTrigger = React.forwardRef(({ className, asChild, ...props }, ref) => {
